...
class DataTransformationConfig:
    preprocessor_obj_file_path = preprocessing_obj_file
...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        try:
            ...
            logging.info(f"Pipeline Completed, Preprocessor obj:[{preprocessor}]")
            
            return preprocessor
            
        except Exception as e:
            logging.info("Exception occured in the get_data_transformation_object")
